...
export const ORG_UNITS: OrgUnit[] = [
    ...
    },
    {
        ...
        shortLabel: "VP Student",
        type: "leadership",
        aliases: ["student development", "alumni relations", "vp student"],
        fileStoreDisplayName: "UTAR General Knowledge Base",
        enabledForChat: false,
        enabledForUpload: true,
        studentFacing: true,
    ...
    },
    {
        ...
        shortLabel: "DEA",
        type: "division",
        aliases: ["dea", "exam", "examination", "awards", "results", "exam timetable"],
        fileStoreDisplayName: "UTAR DEA Knowledge Base",
        enabledForChat: true,
        enabledForUpload: true,
        studentFacing: true,
    },
    ...
    // Student affairs / campus services
    {
        ...
        type: "department",
        campus: "Kampar",
        aliases: ["dsa kampar", "student affairs kampar", "student affairs", "student activity"],
    ...
    },
    {
        ...
        type: "department",
        campus: "Sungai Long",
        aliases: ["dsa sungai long", "student affairs sungai long", "student affairs"],
    ...
    },
    {
        ...
        shortLabel: "Security Kampar",
        type: "department",
        campus: "Kampar",
        aliases: ["security kampar", "safety kampar", "emergency kampar"],
        fileStoreDisplayName: "UTAR Security Kampar Knowledge Base",
        enabledForChat: true,
        enabledForUpload: true,
        studentFacing: true,
    },
    {
        id: "security-sungai-long",
        name: "Department of Safety and Security (Sungai Long Campus)",
        shortLabel: "Security Sungai Long",
        type: "department",
        campus: "Sungai Long",
        aliases: ["security sungai long", "safety sungai long", "emergency sungai long"],
        fileStoreDisplayName: "UTAR Security Sungai Long Knowledge Base",
        enabledForChat: true,
        enabledForUpload: true,
        studentFacing: true,
    },
    ...
    },
    {
        ...
        type: "faculty",
        campus: "Kampar",
        aliases: ["fbf", "business and finance", "teh hong piow", "business faculty", "finance faculty"],
