...
export const ORG_UNITS: OrgUnit[] = [
    ...
    },
    {
        ...
        fileStoreDisplayName: "UTAR DSSC Knowledge Base",
        enabledForChat: true,
        enabledForUpload: true,
        studentFacing: true,
    },
    ...
    },
    {
        ...
        type: "department",
        campus: "Kampar",
        aliases: ["dgs kampar", "general services kampar", "kampar bus", "kampar bus schedule", "kampar shuttle bus", "kampar bus service"],
    ...
    },
    {
        ...
        type: "department",
        campus: "Sungai Long",
        aliases: ["dgs sungai long", "general services sungai long", "sungai long bus", "sungai long bus schedule", "sungai long shuttle bus", "sungai long bus service", "sl bus"],
