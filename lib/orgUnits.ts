...
export const ORG_UNITS: OrgUnit[] = [
    ...
    },
    {
        ...
        fileStoreDisplayName: "UTAR Registrar's Office Knowledge Base",
        enabledForChat: true,
        enabledForUpload: true,
        studentFacing: true,
    },
    ...
    },
    {
        ...
        type: "department",
        aliases: ["dsfa", "scholarship", "scholarships", "financial aid", "loan", "bursary"],
    ...
    },
    {
        ...
        type: "department",
        campus: "Kampar",
        aliases: ["dgs", "dgs kampar", "general services", "room booking", "teaching room", "venue booking", "general services kampar", "bus", "bus schedule", "shuttle bus", "bus service", "bus services", "transport"],
    ...
    },
    {
        ...
        type: "department",
        campus: "Sungai Long",
        aliases: ["dgs", "dgs sungai long", "general services", "room booking", "teaching room", "venue booking", "general services sungai long", "bus", "bus schedule", "shuttle bus", "bus service", "bus services", "transport"],
    ...
    {
        id: "dice",
        name: "Department of Innovation & Commercialisation",
        shortLabel: "DICE",
        type: "department",
        aliases: ["dice", "innovation", "commercialisation", "unovate", "unovate centre", "utaryess"],
        fileStoreDisplayName: "UTAR DICE Knowledge Base",
        enabledForChat: true,
        enabledForUpload: true,
        studentFacing: true,
    },
